...
def help_manual():
    ...
    st.write("Welcome to MathTalk, a speech-to-symbol approach designed to make mathematical notation easier through speech recognition. This manual will guide you through the process of using MathTalk effectively to convert spoken mathematical expressions into symbolic equations.")
    st.markdown("<h3>2. System requirements</h3>", unsafe_allow_html=True)
    st.write("To use MathTalk, you will need:")
    st.markdown("""
    ...
    st.write("To begin using MathTalk, follow these steps:")
    st.markdown("""
                    - Launch the MathTalk application on your device.
    ...
    st.write("MathTalk supports the following audio file formats for input:")
    st.markdown("""
                    - WAV
                    - AIFF
                    - AIFF-C
    ...
    st.write("Here are some commands you can use with MathTalk:")
    st.markdown("""
    ...
    st.write("If you encounter any issues while using MathTalk, consider the following troubleshooting steps:")
    st.markdown("""
...
def about_us():
    ...
    st.write("At MathTalk, we are dedicated to revolutionizing the way mathematical notation is expressed and understood. Our mission is to provide a seamless and intuitive platform that enables users to effortlessly convert spoken mathematical expressions into symbolic equations.")
    ...
    st.markdown("<h3>Why math talk?</h3>", unsafe_allow_html=True)
    st.markdown("""
                    - Simplicity: MathTalk streamlines the process of converting spoken language into mathematical notation, making it accessible to everyone.
                    ...
                    - Accessibility: MathTalk breaks down barriers to mathematical understanding, enabling users of all skill levels to engage with complex concepts.
                    """)
    
    

# Streamlit app
st.set_page_config(layout="centered", page_title="MathTalk", page_icon=":123:",  initial_sidebar_state="expanded")
...
# Display image in the first column
    col1.image('image.png', use_column_width=True)
